...
public class PaymentErrorCallback extends PaymentSuccessCallback {
	...
	{
		super(transactionLogCache, transactionLogAerospikeDao, dependencyServicesCommunicator, currencyManager, userAccountManager, tracker, paymentServiceCommunicator, paymentConfig);
	}
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			if (logId != null) {
				...
				if(appId != null) {
					pushMessageToUser(transactionLog, transactionId, userId, Messages.PAYMENT_SYSTEM_PAYMENT_ERROR_PUSH, WebsocketMessageType.PAYMENT_FAILURE, appId);
				}
			}
		} catch (Exception e) {
