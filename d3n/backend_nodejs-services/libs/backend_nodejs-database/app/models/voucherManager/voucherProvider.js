...
module.exports = function (sequelize, DataTypes) {
    return sequelize.define('voucherProvider', {
        id: {
        ...
        classMethods: {
            associate: function (models) {
                ...
                this.hasMany(models.voucher, { foreignKey: 'voucherProviderId', onDelete: 'NO ACTION', onUpdate: 'NO ACTION' });
                this.hasMany(models.voucherProviderHasRegionalSetting, { foreignKey: 'voucherProviderId', onDelete: 'NO ACTION', onUpdate: 'NO ACTION' });
            },
            constants: function () {
                return _constants;
            }
