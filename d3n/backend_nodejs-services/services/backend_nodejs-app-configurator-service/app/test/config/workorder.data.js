...
module.exports = {
    ...
    cleanManyToMany: function (done) {
        ...
        RdbmsService.load()
            ...
            .removeSeries(WorkorderHasResource, [self.WORKORDER_1_HAS_RESOURCE, self.WORKORDER_2_HAS_RESOURCE], 'workorderId')
    ...
    loadManyToMany: function (done) {
        ...
        RdbmsService.load()
            ...
            .createSeries(WorkorderHasResource, [self.WORKORDER_1_HAS_RESOURCE, self.WORKORDER_2_HAS_RESOURCE], 'workorderId')
