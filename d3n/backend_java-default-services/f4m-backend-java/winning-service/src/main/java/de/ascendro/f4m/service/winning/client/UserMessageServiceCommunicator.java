...
public class UserMessageServiceCommunicator {
    ...
    @Inject
    public UserMessageServiceCommunicator(WinningConfig config, JsonMessageUtil jsonUtil, JsonWebSocketClientSessionPool jsonWebSocketClientSessionPool, ServiceRegistryClient serviceRegistryClient) {
        this.config = config;
