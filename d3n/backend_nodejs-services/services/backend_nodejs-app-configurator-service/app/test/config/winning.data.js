...
module.exports = {
    ...
    WINNING_COMPONENT_INACTIVE: {
        id: DataIds.WINNING_COMPONENT_INACTIVE_ID,
        title: 'wc_inactive',
        description: 'description',
        rules: 'rules',
        status: WinningComponent.constants().STATUS_INACTIVE,
    ...
    loadClassifiers: function (done) {
        var self = this;
        RdbmsService.load()
            .createSeries(WinningComponent, [self.WINNING_COMPONENT_1, self.WINNING_COMPONENT_2, self.WINNING_COMPONENT_INACTIVE])
