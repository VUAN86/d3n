...
module.exports = {
    ...
    cleanEntities: function (done) {
        ...
        RdbmsService.load()
            ...
            .removeSeries(PaymentStructureTier, [self.PAYMENT_STRUCTURE_TIER_1_1, self.PAYMENT_STRUCTURE_TIER_2_1, self.PAYMENT_STRUCTURE_TIER_2_2, self.PAYMENT_STRUCTURE_TIER_TEST])
    ...
    loadEntities: function (done) {
        ...
        RdbmsService.load()
            ...
            .createSeries(PaymentStructureTier, [self.PAYMENT_STRUCTURE_TIER_1_1, self.PAYMENT_STRUCTURE_TIER_2_1, self.PAYMENT_STRUCTURE_TIER_2_2])
