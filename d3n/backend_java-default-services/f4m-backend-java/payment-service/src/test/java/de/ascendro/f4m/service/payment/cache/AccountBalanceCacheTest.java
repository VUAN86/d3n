...
//		GetAccountBalanceRequest loadOrWithdrawWithoutCoverage = EnhancedRandom.random(GetAccountBalanceRequest.class);
...
//		when(userAccountManager.getAccountBalance(paymentClientInfo, loadOrWithdrawWithoutCoverage)).thenReturn(balanceResponse);
//
//		cache.getAccountBalance(paymentClientInfo, loadOrWithdrawWithoutCoverage);
...
//		GetAccountBalanceRequest loadOrWithdrawWithoutCoverage = EnhancedRandom.random(GetAccountBalanceRequest.class);
//		loadOrWithdrawWithoutCoverage.setCurrency(Currency.BONUS);
...
//		doThrow(exception).when(userAccountManager).getAccountBalance(paymentClientInfo, loadOrWithdrawWithoutCoverage);
//		when(emailForwarder.shouldForwardErrorToAdmin(any())).thenReturn(true);
//
//		GetAccountBalanceResponse response = cache.getAccountBalance(paymentClientInfo, loadOrWithdrawWithoutCoverage);
//		assertThat(response.getAmount(), comparesEqualTo(new BigDecimal("12.34")));
//		assertThat(response.getCurrency(), equalTo(loadOrWithdrawWithoutCoverage.getCurrency()));
