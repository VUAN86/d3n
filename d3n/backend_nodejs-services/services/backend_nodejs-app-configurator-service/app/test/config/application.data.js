...
module.exports = {
    ...
    cleanManyToMany: function (done) {
        ...
        RdbmsService.load()
            ...
            .removeSeries(ApplicationHasTombola, [self.APPLICATION_1_HAS_TOMBOLA_1, self.APPLICATION_2_HAS_TOMBOLA_2], 'applicationId')
            .removeSeries(ApplicationHasPromocodeCampaign, [self.APPLICATION_1_HAS_PROMOCODE_CAMPAIGN_1, self.APPLICATION_2_HAS_PROMOCODE_CAMPAIGN_2, self.APPLICATION_2_HAS_PROMOCODE_CAMPAIGN_INACTIVE], 'applicationId')
    ...
    loadManyToMany: function (done) {
        var self = this;
        RdbmsService.load()
            .createSeries(ApplicationHasPromocodeCampaign, [self.APPLICATION_1_HAS_PROMOCODE_CAMPAIGN_1, self.APPLICATION_2_HAS_PROMOCODE_CAMPAIGN_2, self.APPLICATION_2_HAS_PROMOCODE_CAMPAIGN_INACTIVE], 'applicationId')
            .createSeries(ApplicationHasTombola, [self.APPLICATION_1_HAS_TOMBOLA_1, self.APPLICATION_2_HAS_TOMBOLA_2], 'applicationId')
