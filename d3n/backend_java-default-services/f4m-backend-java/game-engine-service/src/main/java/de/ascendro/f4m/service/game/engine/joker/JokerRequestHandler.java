...
public class JokerRequestHandler {
	...
	public JsonMessageContent handlePurchaseJokerRequest(JsonMessage<? extends PurchaseJokerRequest> message, SessionWrapper sessionWrapper, long receiveTimestamp) {
		...
		switch (type) {
		case SKIP:
			questionSkipped(gameInstance, sessionWrapper, message.getClientInfo(), questionIndex, receiveTimestamp);
