...
public class PaymentManagerMockImpl implements PaymentManager {
	...
	@Override
	public ConvertBetweenCurrenciesUserResponse convertBetweenCurrencies(PaymentClientInfo paymentClientInfo,
		...
		return new ConvertBetweenCurrenciesUserResponse("");
	}
