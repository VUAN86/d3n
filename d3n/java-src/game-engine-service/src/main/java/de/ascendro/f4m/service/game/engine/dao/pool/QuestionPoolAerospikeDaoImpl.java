...
public class QuestionPoolAerospikeDaoImpl extends AerospikeDaoImpl<QuestionPoolPrimaryKeyUtil> implements QuestionPoolAerospikeDao {
	 ...
	 * @param poolKeyFunction - build question pool key from <poolId, type, complexity> 
	 * @param sizeFunction - obtain pool size by reviously constructed question pool key
