...
import de.ascendro.f4m.service.game.engine.model.history.*;
import de.ascendro.f4m.service.game.engine.model.joker.*;
...
public class GameEngineMessageTypeMapper extends JsonMessageTypeMapImpl {
	...
	protected void init() {
		...
		register(GameEngineMessageTypes.CANCEL_TOURNAMENT_GAME, new TypeToken<CancelTournamentGame>() {});
		register(GameEngineMessageTypes.CANCEL_TOURNAMENT_GAME_RESPONSE, new TypeToken<CancelTournamentGameResponse>() {});

		register(GameEngineMessageTypes.PLAYER_GAME_HISTORY, new TypeToken<PlayerGameHistoryRequest>() {});
		register(GameEngineMessageTypes.PLAYER_GAME_HISTORY_RESPONSE, new TypeToken<PlayerGameHistoryResponse>() {});
	}
}
