...
//	private final ServiceRegistryClient serviceRegistryClient;
	...
	@Inject
	public PaymentServiceCommunicator(
//			JsonWebSocketClientSessionPool jsonWebSocketClientSessionPool,
//			ServiceRegistryClient serviceRegistryClient,
			JsonMessageUtil jsonUtil, TransactionLogAerospikeDao transactionLogAerospikeDao,
...
//		this.serviceRegistryClient = serviceRegistryClient;
	...
	public void requestWinningTransfer(JsonMessage<? extends JsonMessageContent> sourceMessage,
		...
		final UserWinningComponentRequestInfo requestInfo = new UserWinningComponentRequestInfo(sourceMessage, sourceMessage.getMessageSource(), userWinningComponent, superPrize);
	...
	public void requestAssignWinningComponentPayment(JsonMessage<? extends JsonMessageContent> sourceMessage,
		...
		final PaymentRequestInfo requestInfo = new PaymentRequestInfo(sourceMessage, sourceMessage.getMessageSource(), gameId);
...
//			final ServiceConnectionInformation paymentServConnInfo = serviceRegistryClient.getServiceConnectionInformation(PaymentMessageTypes.SERVICE_NAME);
	...
	public void requestTenantBalance(JsonMessage<? extends JsonMessageContent> sourceMessage, WinningComponentMoneyCheckRequestInfo requestInfo) {
...
//			final ServiceConnectionInformation paymentServiceConnInfo = serviceRegistryClient.getServiceConnectionInformation(PaymentMessageTypes.SERVICE_NAME);
			RabbitClientSender.sendAsyncMessageNoClientInfo(PaymentMessageTypes.SERVICE_NAME, getAccountBalanceMessage, requestInfo);
		} catch (F4MValidationFailedException | F4MIOException e) {
