...
public class PaymentGetJackpotRequestInfo extends RequestInfoImpl{
	...
	public PaymentGetJackpotRequestInfo(Game game, JsonMessage<?> sourceMessage, SessionWrapper sourceSession) {
		super(sourceMessage, sourceSession);
		this.game = game;
	}

	public PaymentGetJackpotRequestInfo(Invitation invitation, JsonMessage<?> sourceMessage, SessionWrapper sourceSession) {
		super(sourceMessage, sourceSession);
		this.invitation = invitation;
	}

	public PaymentGetJackpotRequestInfo(SimpleGameInfo gameInfo, JsonMessage<?> sourceMessage, SessionWrapper sourceSession) {
		super(sourceMessage, sourceSession);
