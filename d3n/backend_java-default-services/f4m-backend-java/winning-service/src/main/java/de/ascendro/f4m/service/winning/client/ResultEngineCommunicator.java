...
public class ResultEngineCommunicator {
	...
	public void requestGameInstanceResults(JsonMessage<? extends JsonMessageContent> sourceMessage, SessionWrapper sourceSession, String gameInstanceId) {
		final RequestInfo requestInfo = new RequestInfoImpl(sourceMessage, sourceSession);
	...
	public void storeUserWinningComponentInResults(JsonMessage<UserWinningComponentAssignRequest> sourceMessage, 
			SessionWrapper sourceSession, UserWinningComponent userWinningComponent) {
		final UserWinningComponentRequestInfo requestInfo =
				new UserWinningComponentRequestInfo(sourceMessage, sourceSession, userWinningComponent, null);
