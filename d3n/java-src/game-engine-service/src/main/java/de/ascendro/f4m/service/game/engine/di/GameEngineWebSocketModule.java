...
public class GameEngineWebSocketModule extends WebSocketModule {
	...
	static class GameEngineServiceClientMessageHandlerProvider extends DefaultJsonMessageHandlerProviderImpl {
		...
		protected JsonMessageHandler createServiceMessageHandler() {
			return new GameEngineServiceClientMessageHandler(gameEngine, jokerRequestHandler, transactionLogAerospikeDao, winningCommunicator,
					eventSubscriptionManager, messageCoordinator, tracker, gameSelectionCommunicator, multiplayerGameManager, serviceUtil);
		}
	}
