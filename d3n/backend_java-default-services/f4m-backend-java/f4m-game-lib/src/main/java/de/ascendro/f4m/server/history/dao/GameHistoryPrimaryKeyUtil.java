...
public class GameHistoryPrimaryKeyUtil extends PrimaryKeyUtil<String> {
	...
	private static final String PLAYER_GAMEINSTANCE_KEY_FORMAT = "profile:%s:gameInstanceId:%s";
	...
	public String createPlayerGameInstancePrimaryKey(String userId, String instanceId) {
		return String.format(PLAYER_GAMEINSTANCE_KEY_FORMAT, userId, instanceId);
	}
