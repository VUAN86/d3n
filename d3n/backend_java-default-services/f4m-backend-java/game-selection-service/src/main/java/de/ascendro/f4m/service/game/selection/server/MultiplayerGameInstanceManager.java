...
public interface MultiplayerGameInstanceManager {
    ...
    void sendTransferMinimumJackpotGuarantee(String mgiId);
	...
	void inviteUserIfNotExist(String userId, String mgiId, GameType gameType);
	...
	void validateIsGameHasStartedDateTime(ClientInfo clientInfo, String mgiId);
