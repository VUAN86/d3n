...
public class UserWinningComponentRequestInfo extends PaymentRequestInfo {
	...
	public UserWinningComponentRequestInfo(JsonMessage<?> sourceMessage, SessionWrapper sourceSession, 
			UserWinningComponent userWinningComponent, SuperPrize superPrize) {
		super(sourceMessage, sourceSession, userWinningComponent == null ? null : userWinningComponent.getGameId());
