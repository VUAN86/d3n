...
public class VoucherServiceCommunicator {
	...
	@Inject
	public VoucherServiceCommunicator(JsonMessageUtil jsonMessageUtil, JsonWebSocketClientSessionPool jsonWebSocketClientSessionPool, 
	...
	public void requestUserVoucherAssign(JsonMessage<? extends JsonMessageContent> sourceMessage, SessionWrapper session,
		...
		final RequestInfo requestInfo = new UserWinningComponentRequestInfo(sourceMessage, session, userWinningComponent, null);
		try {
