...
module.exports = {
    ...
    cleanEntities: function (done) {
        ...
        RdbmsService.load()
            ...
            .removeSeries(Application, [self.APPLICATION_1, self.APPLICATION_2, self.APPLICATION_NO_DEPENDENCIES, self.APPLICATION_TEST])
            .process(function (err) {
                if (err) {
                    return done(err);
                }
    ...
    loadEntities: function (done) {
        var self = this;
        RdbmsService.load()
            .createSeries(Application, [self.APPLICATION_1, self.APPLICATION_2, self.APPLICATION_NO_DEPENDENCIES])
