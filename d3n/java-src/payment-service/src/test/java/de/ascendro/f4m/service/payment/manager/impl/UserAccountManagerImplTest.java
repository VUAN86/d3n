...
public class UserAccountManagerImplTest {
	...
	public void testZipConvertion() throws Exception {
		assertEquals(new Long(1122), userAccountManager.convertStringZipCodeToLong("1122"));
		assertEquals(UserAccountManagerImpl.UNPARSEABLE_ZIP, userAccountManager.convertStringZipCodeToLong("LV-1122"));
		assertEquals(UserAccountManagerImpl.UNPARSEABLE_ZIP, userAccountManager.convertStringZipCodeToLong(""));
		assertEquals(UserAccountManagerImpl.UNKNOWN_ZIP, userAccountManager
				.convertStringZipCodeToLong(String.valueOf(UserAccountManagerImpl.ZIP_NOT_ALLOWED_VALUE)));
	}
