...
When writing a web application with commonjs modules, vis.js can be packaged automatically into the application. Create a file **app.module.js** containing:
...
The application can be bundled and minified:
    ...
    $ browserify app.module.js -o app-bundle.js -t babelify
