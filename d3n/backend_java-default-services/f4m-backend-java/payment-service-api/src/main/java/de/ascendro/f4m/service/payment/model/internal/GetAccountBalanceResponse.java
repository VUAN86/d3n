...
public class GetAccountBalanceResponse implements JsonMessageContent {
	...
	public GetAccountBalanceResponse(BigDecimal amount, Currency currency) {
		this.amount = amount;
		this.currency = currency;
	}

	public GetAccountBalanceResponse amount(BigDecimal amount) {
		this.amount = amount;
		return this;
	}

	public GetAccountBalanceResponse currency(Currency currency) {
		this.currency = currency;
		return this;
	}
