...
public class ActiveGameInstanceDaoImpl  extends AerospikeDaoImpl<GameEnginePrimaryKeyUtil> implements ActiveGameInstanceDao {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ActiveGameInstanceDaoImpl.class);
	...
	public void updateStatus(String gameInstanceId, GameStatus status, GameEndStatus endStatus) {
		...
		LOGGER.debug("updateStatus gameInstanceId {} - status {} - endStatus {} - key {} - set {} ", gameInstanceId, status, endStatus, gameInstanceKey, getSet());
