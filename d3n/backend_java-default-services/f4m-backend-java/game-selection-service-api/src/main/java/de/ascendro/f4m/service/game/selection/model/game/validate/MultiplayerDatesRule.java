...
public class MultiplayerDatesRule implements CustomParameterRule<MultiplayerGameParameters> {
	private static final Logger LOGGER = LoggerFactory.getLogger(MultiplayerDatesRule.class);
...
//	private static final int MIN_USER_LIVE_TOURNAMENT_MINUTES = 1; //FIXME: testing value
	...
	private void validateDates(MultiplayerGameParameters params, Game game) {
		...
		LOGGER.debug("validateDates gameFrom {} gameTo {} configFrom {} configTo {} ", gameFrom, gameTo, configFrom, configTo);
		LOGGER.debug("validateDates configFrom.isBefore(gameFrom) {} ", configFrom.isBefore(gameFrom));
