...
import de.ascendro.f4m.service.achievement.AchievementServiceStartup;

public class AchievementServiceStartupUsingAerospikeMock extends AchievementServiceStartup {


    public AchievementServiceStartupUsingAerospikeMock(Stage stage) {
        super(stage);
    }
    ...
    protected Iterable<? extends Module> getModules() {
        return Arrays.asList(getAchievementServiceAerospikeOverrideModule());
    }

    protected AbstractModule getAchievementServiceAerospikeOverrideModule() {
