...
public class TombolaServiceServerMessageHandler extends DefaultJsonMessageHandler {
    ...
    private JsonMessageContent onTombolaBuy(ClientInfo clientInfo, JsonMessage<? extends JsonMessageContent> message) {
        ...
        tombolaManager.initiateBuyTicketsPaymentTransfer(message, bundle, getSessionWrapper(), clientInfo.getUserId(),
    ...
    private JsonMessageContent onTombolaDraw(JsonMessage<? extends JsonMessageContent> message, ClientInfo clientInfo,
        ...
        tombolaDrawingEngine.tombolaDraw(request.getTombolaId(), clientInfo.getTenantId(), getSessionWrapper(),
                message);
        return new EmptyJsonMessageContent();
    }
}
