...
public class InvitationGame {
	...
	public String toString() {
		...
		builder.append("InvitationGame [id=");
		builder.append(id);
		...
		builder.append(", type=");
		builder.append(type);
		builder.append(", assignedPools=");
		builder.append(Arrays.toString(assignedPools));
		builder.append(", assignedPoolsColors=");
		builder.append(Arrays.toString(assignedPoolsColors));
		builder.append(", assignedPoolsNames=");
		builder.append(Arrays.toString(assignedPoolsNames));
		builder.append(", assignedPoolsIcons=");
		builder.append(Arrays.toString(assignedPoolsIcons));
