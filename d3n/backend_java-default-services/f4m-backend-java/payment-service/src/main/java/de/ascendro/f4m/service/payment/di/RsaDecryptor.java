...
public class RsaDecryptor {
	...
	public String decryptKey(String encrypted) throws F4MIOException {
		...
		LOGGER.debug("decryptKey private_key {} , system_key {} autoKey {}",
				paymentConfig.getProperty(PaymentConfig.PAYMENT_SYSTEM_PRIVATE_KEY_PATH), paymentConfig.getProperty(PaymentConfig.PAYMENT_SYSTEM_KEY_PASSWORD)
				, paymentConfig.getProperty(PaymentConfig.PAYMENT_SYSTEM_AUTH_PATH));
