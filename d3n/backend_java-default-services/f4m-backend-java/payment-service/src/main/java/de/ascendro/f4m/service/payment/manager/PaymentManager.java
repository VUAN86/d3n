...
public interface PaymentManager {
	...
	GetTransactionResponse getTransaction(GetTransactionRequest request, Callback<GetTransactionResponse> originalCallback);

	GetAccountHistoryResponse getAccountHistory(PaymentClientInfo paymentClientInfo, GetUserAccountHistoryRequest request);

	ConvertBetweenCurrenciesUserResponse convertBetweenCurrencies(PaymentClientInfo paymentClientInfo, ConvertBetweenCurrenciesUserRequest request,
