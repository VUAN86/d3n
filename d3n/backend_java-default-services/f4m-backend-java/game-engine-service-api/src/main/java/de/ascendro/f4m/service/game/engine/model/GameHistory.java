...
public class GameHistory extends JsonObjectWrapper {
	...
	public String getGameId() {
		return getPropertyAsString(GAME_ID_PROPERTY);
	}
	...
	public long getTimestamp(){
		return getPropertyAsLong(LAST_UPDATE_TIMESTAMP_PROPERTY);
	}

	public ZonedDateTime getEndDateTime() {
		Calendar calendar = Calendar.getInstance();
		calendar.setTimeInMillis(getPropertyAsLong(LAST_UPDATE_TIMESTAMP_PROPERTY));
