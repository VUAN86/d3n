...
public interface CommonMultiplayerGameInstanceDao {
	...
	String NUMBER_OF_ATTEMPTS = "count";
	...
	void createOrUpdateTournamentLong(String mgiId, String userId, String binName, Long numberOfApproaches);

	void recordUserHandicap(String mgiId, String userId, String userHandicap);

	double getUserHandicap(String mgiId, String userId);

    void createOrUpdateGameInstanceIdOfPreviousGame(String mgiId, String userId, String gameInstanceId);

	String getGameInstanceOfThePreviousGame(String mgiId, String userId);

	Long numberOfAttempts(String mgiId, String userId);
	 ...
	 */
	boolean registerForGame(String mgiId, ClientInfo clientInfo, String gameInstanceId);

    void removalOfThePreviousAttempt(String mgiId, ClientInfo clientInfo, String gameInstanceId);
	/**
